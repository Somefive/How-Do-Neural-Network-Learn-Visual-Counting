...
# Generators
training_set = MNISTDataset(10000, grid_size=args.grid_size, target=target, interference=args.interf)
training_generator = data.DataLoader(training_set, **params)

validation_set = MNISTDataset(10, grid_size=args.grid_size, target=target, interference=args.interf)
